...
OWNED_KEYS=" SERVER_PORT DB_URL DB_USER DB_PASSWORD JWT_SECRET JWT_EXPIRATION CORS_ORIGINS FRONTEND_URL GCS_BUCKET_NAME GEMINI_API_KEY GOOGLE_DRIVE_CLIENT_ID GOOGLE_DRIVE_CLIENT_SECRET GOOGLE_SIGNIN_REDIRECT_URI SEED_DEMO_DATA "
